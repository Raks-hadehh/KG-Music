...
from KGmusic.config import SOURCE_CODE,ASSISTANT_NAME,PROJECT_NAME,SUPPORT_GROUP,BOT_USERNAME, OWNER
...
from KGmusic.services.callsmusic.callsmusic import client as USER
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        try:
            ...
            await lel.edit(
                "💁🏻‍♀️ **Devansa Tidak Dapat Menemukan Lagu** Coba cari dengan judul lagu yang lebih jelas, Ketik `/help` bila butuh bantuan"
            )
            print(str(e))
            return
        dlurl=url
